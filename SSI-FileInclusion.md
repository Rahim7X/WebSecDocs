# File Inclusion
In path traversal the attacker can accesss the file or directory outside of the intended scope. Meanwhile in File inclusion attacker can include arbitrary file and execute it.
- Loading a source code or image
- Loading a pdf internal or external
- Loading config file to make the server behaive unintended way

# ways to escalate RCE  in PHP
